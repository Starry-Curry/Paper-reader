#!/usr/bin/env node
/**
 * paper-to-course HTML → Markdown Converter (legacy migration helper)
 *
 * Converts an older generated HTML course into Markdown.
 * The default workflow authors paper-notes.md independently and does not call this script.
